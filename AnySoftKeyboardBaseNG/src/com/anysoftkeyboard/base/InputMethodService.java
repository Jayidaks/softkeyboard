...
//    Handler mCandidatesFrameHandler;
//    final Runnable mShowCandidatesAreaRunner = new Runnable() {
//		@Override
//		public void run() {
//			showCandidatesArea();
//		}
...
//        }
        ...
        //mCandidatesFrameHandler = new Handler();
...
//	private void hideCandidatesArea() {
//		if (mCandidatesVisibility != View.VISIBLE)
//		{
//			mCandidatesFrame.getLayoutParams().height = 0;
//			Log.d("ASK", "Height: "+mCandidatesFrame.getLayoutParams().height);
//			if (mCandidatesFrame.getLayoutParams().height > 0)
//			{
//				mCandidatesFrame.getLayoutParams().height-=2;
//				mCandidatesFrame.requestLayout();
//				mCandidatesFrameHandler.postDelayed(mHideCandidatesAreaRunner, 2);
//			}
//		}
//	}
	
//	private void showCandidatesArea() {
//		if (mCandidatesVisibility == View.VISIBLE)
//		{
//			Log.d("ASK", "Height: "+mCandidatesFrame.getLayoutParams().height);
//			if (mCandidatesFrame.getLayoutParams().height < 0)
//				mCandidatesFrame.getLayoutParams().height = 0;
//			
//			if (mCandidatesFrame.getLayoutParams().height < 70)
//			{
//				mCandidatesFrame.getLayoutParams().height+=4;
//				mCandidatesFrame.requestLayout();
//				mCandidatesFrameHandler.postDelayed(mShowCandidatesAreaRunner, 1);
//			}
//		}
//	}
...
//
//private void showCandidatesArea() {
//	mCandidatesFrame.getLayoutParams().height = LayoutParams.WRAP_CONTENT;
//}
    //workaround function
    /*
