...
public abstract class AnySoftKeyboardConfiguration 
{
	...
	static class AnySoftKeyboardConfigurationImpl extends AnySoftKeyboardConfiguration
	{
		...
		public AnySoftKeyboardConfigurationImpl(Context context)
		{
			...
			customizeSettingValues(mContext, sp);
...
//			}
		...
		private void upgradeSettingsValues(SharedPreferences sp) {
			...
			String topRowNewIdValue = sp.getString(mContext.getString(com.anysoftkeyboard.ng.R.string.settings_key_top_keyboard_row_id), null);
			...
			if (topRowNewIdValue == null && topRowOldIdValue != null)
			{
				...
				Editor e = sp.edit();
				e.putString(mContext.getString(com.anysoftkeyboard.ng.R.string.settings_key_top_keyboard_row_id), topRowOldIdValue);
			...
			if (configurationVersion < 1)
			{
				boolean oldLandscapeFullScreenValue = sp.getBoolean("fullscreen_input_connection_supported", 
						mContext.getResources().getBoolean(com.anysoftkeyboard.ng.R.bool.settings_default_landscape_fullscreen));
				if (DEBUG)Log.d(TAG, "Replacing landscape-fullscreen key...");
				Editor e = sp.edit();
				e.putBoolean(mContext.getString(com.anysoftkeyboard.ng.R.string.settings_key_landscape_fullscreen), oldLandscapeFullScreenValue);
		...
		public void handleConfigurationChange(SharedPreferences sp)
		{
			...
			mLayoutChangeKeysSize = sp.getString(mContext.getResources().getString(com.anysoftkeyboard.ng.R.string.settings_key_top_keyboard_row_id), mContext.getResources().getString(R.string.settings_default_top_keyboard_row_id));
			...
			mUseFullScreenInputInLandscape = sp.getBoolean(mContext.getResources().getString(com.anysoftkeyboard.ng.R.string.settings_key_landscape_fullscreen), 
					mContext.getResources().getBoolean(com.anysoftkeyboard.ng.R.bool.settings_default_landscape_fullscreen));
