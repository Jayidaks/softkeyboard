...
import com.anysoftkeyboard.ng.keyboards.GenericKeyboard;
...
//	}
    ...
    KeyboardSwitcher(AnySoftKeyboard context) {
    	...
    	KEYBOARDMODE_NORMAL = res.getInteger(com.anysoftkeyboard.ng.R.integer.keyboard_mode_normal);
    	KEYBOARDMODE_IM = res.getInteger(com.anysoftkeyboard.ng.R.integer.keyboard_mode_im);
    	KEYBOARDMODE_URL = res.getInteger(com.anysoftkeyboard.ng.R.integer.keyboard_mode_url);
    	KEYBOARDMODE_EMAIL = res.getInteger(com.anysoftkeyboard.ng.R.integer.keyboard_mode_email);
	    	...
	    	switch(keyboardIndex)
	    	{
	    		case SYMBOLS_KEYBOARD_REGULAR_INDEX:
	    			if (AnyApplication.getConfig().use16KeysSymbolsKeyboards())
	    				keyboard = new GenericKeyboard(mContext, com.anysoftkeyboard.ng.R.xml.symbols_16keys, com.anysoftkeyboard.ng.R.xml.symbols, com.anysoftkeyboard.ng.R.string.symbols_keyboard, "symbols_keyboard", mode);
	    			else
	    				keyboard = new GenericKeyboard(mContext, com.anysoftkeyboard.ng.R.xml.symbols, com.anysoftkeyboard.ng.R.string.symbols_keyboard, "symbols_keyboard", mode);
	    			break;
	    		case SYMBOLS_KEYBOARD_ALT_INDEX:
	    			if (AnyApplication.getConfig().use16KeysSymbolsKeyboards())
	    				keyboard = new GenericKeyboard(mContext, com.anysoftkeyboard.ng.R.xml.symbols_alt_16keys, com.anysoftkeyboard.ng.R.xml.symbols_alt, com.anysoftkeyboard.ng.R.string.symbols_keyboard, "symbols_keyboard", mode);
	    			else
	    				keyboard = new GenericKeyboard(mContext, com.anysoftkeyboard.ng.R.xml.symbols_alt, com.anysoftkeyboard.ng.R.string.symbols_keyboard, "alt_symbols_keyboard", mode);
	    			break;
	    		case SYMBOLS_KEYBOARD_ALT_NUMBERS_INDEX:
	    			keyboard = new GenericKeyboard(mContext, com.anysoftkeyboard.ng.R.xml.simple_alt_numbers, com.anysoftkeyboard.ng.R.string.symbols_keyboard, "alt_numbers_symbols_keyboard", mode);
	    			break;
	    		case SYMBOLS_KEYBOARD_PHONE_INDEX:
	    			keyboard = new GenericKeyboard(mContext, com.anysoftkeyboard.ng.R.xml.simple_phone, com.anysoftkeyboard.ng.R.string.symbols_keyboard, "phone_symbols_keyboard", mode);
	    			if (mInputView != null)
	            		mInputView.setPhoneKeyboard(keyboard);
	    			break;
	    		case SYMBOLS_KEYBOARD_NUMBERS_INDEX:
	    			keyboard = new GenericKeyboard(mContext, com.anysoftkeyboard.ng.R.xml.simple_numbers, com.anysoftkeyboard.ng.R.string.symbols_keyboard, "numbers_symbols_keyboard", mode);
	    			break;
	    		case SYMBOLS_KEYBOARD_DATETIME_INDEX:
	    			keyboard = new GenericKeyboard(mContext, com.anysoftkeyboard.ng.R.xml.simple_datetime, com.anysoftkeyboard.ng.R.string.symbols_keyboard, "datetime_symbols_keyboard", mode);
	    			break;
	    	}
...
//		}
    ...
    private int findLatinKeyboardIndex() {
		...
		{
			if (builder.getKeyboardNameResId() == com.anysoftkeyboard.ng.R.string.eng_keyboard)
				return index; 
		}
