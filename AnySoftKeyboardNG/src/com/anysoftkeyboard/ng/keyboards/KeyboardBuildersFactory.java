...
public class KeyboardBuildersFactory {
    ...
    public interface KeyboardBuilder
    {
         ...
         */
        public static final String RECEIVER_INTERFACE = "com.anysoftkeyboard.ng.KEYBOARD";

        /**
         * Name under which an external keyboard broadcast receiver component
         * publishes information about itself.
         */
        public static final String RECEIVER_META_DATA = "com.anysoftkeyboard.ng.keyboards";
    ...
    //                String iconResId = "com.anysoftkeyboard.ng:drawable/sym_keyboard_notification_icon";
    ...
    //    	Intent keyboards = new Intent("com.anysoftkeyboard.ng.KEYBOARD");
