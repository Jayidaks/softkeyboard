...
//		}
	...
	public synchronized static void showNotificationIcon(Context context) {
		...
		{
			Notification notification = new Notification(com.anysoftkeyboard.ng.R.drawable.notification_icon, context.getResources().getText(com.anysoftkeyboard.ng.R.string.notification_text), System.currentTimeMillis());
            ...
            notification.setLatestEventInfo(context,
                            context.getResources().getText(com.anysoftkeyboard.ng.R.string.ime_name), context.getResources().getText(com.anysoftkeyboard.ng.R.string.notification_text),
                            contentIntent);
