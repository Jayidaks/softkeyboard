	...
	static class AnySoftKeyboardConfigurationImpl extends AnySoftKeyboardConfiguration
	{
		...
		private void customizeSettingValues(Context context, SharedPreferences sp) {
			...
			if (customizationLevel < 1)
			{
				...
				e.putBoolean(context.getString(R.string.settings_key_input_fullscreen), true);
				//no top row
				e.putString(context.getString(R.string.settings_key_top_keyboard_row_id), "None");
				...
				e.putBoolean("keyboard_aa58fb12-6558-4e96-9aa6-0e90101570b3", true);
				
				//sound on
				e.putBoolean(context.getString(R.string.settings_key_sound_on), false);
				//custom volume: mid
		...
		private void upgradeSettingsValues(SharedPreferences sp) {
			...
			if (configurationVersion < 1)
			{
				boolean oldLandscapeFullScreenValue = sp.getBoolean("fullscreen_input_connection_supported", 
						mIme.getResources().getBoolean(R.bool.settings_default_fullscreen));
				Log.d(TAG, "Replacing landscape-fullscreen key...");
				Editor e = sp.edit();
				e.putBoolean(mIme.getString(R.string.settings_key_input_fullscreen), oldLandscapeFullScreenValue);
		...
		public void handleConfigurationChange(SharedPreferences sp)
		{
			...
			mUseFullScreenInput = sp.getBoolean(mIme.getString(R.string.settings_key_input_fullscreen), 
					mIme.getResources().getBoolean(R.bool.settings_default_fullscreen));
			...
			if (mKeysHeightFactorInPortrait > 1.8f)
			{
				mKeysHeightFactorInPortrait = 1.8f;
				Log.i(TAG, "** mKeysHeightFactorInPortrait fixed to: "+mKeysHeightFactorInPortrait);
			}
			else if (mKeysHeightFactorInPortrait < 0.8f)
			{
				mKeysHeightFactorInPortrait = 0.8f;
				Log.i(TAG, "** mKeysHeightFactorInPortrait fixed to: "+mKeysHeightFactorInPortrait);
			}
			...
			if (mKeysHeightFactorInLandscape > 1.8f)
			{
				mKeysHeightFactorInLandscape = 1.8f;
