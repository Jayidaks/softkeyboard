...
import com.android.moduwkeyboard.keyboards.GenericKeyboard;
import com.android.moduwkeyboard.keyboards.KeyboardBuildersFactory;
import com.android.moduwkeyboard.keyboards.KeyboardFactory;
    	...
    	if (keyboard == null)
    	{
	    	switch(keyboardIndex)
	    	{
	    		...
	    		case SYMBOLS_KEYBOARD_DATETIME_INDEX:
	    			keyboard = new GenericKeyboard(mContext, R.xml.simple_numbers, R.string.symbols_keyboard, "datetime_symbols_keyboard", mode);
	    			break;
	    	}
	...
	public AnyKeyboard nextKeyboard(EditorInfo currentEditorInfo, NextKeyboardType type)
	{
		...
		switch(type)
		{
			...
			case PreviousAny://currently we'll support only one direction
			    ...
			    //final int symbolsKeyboardsCount = 1;
			    if (mAlphabetMode)
			    {
