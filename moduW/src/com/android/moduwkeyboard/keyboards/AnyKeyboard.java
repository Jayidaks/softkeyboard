...
import com.android.moduwkeyboard.Workarounds;
...
public abstract class AnyKeyboard extends Keyboard 
{
	...
	public final static int KEYCODE_LANG_CHANGE_WITH_IMAGE = -299;
	public final static int KEYCODE_SYMB_CHANGE_WITH_GLOBES = -202;
	public final static int KEYCODE_SYMB_CHANGE_WITH_IMAGE = -302;
	public final static int KEYCODE_SYMB_ALT_CHANGE_WITH_GLOBES = -206;
...
//                    break;
                ...
                case AnyKeyboard.KEYCODE_KEYBOARD_CYCLE:
                	setIconIfNeeded(key, localResources, R.drawable.globe, R.drawable.globe_feedback);
                    break;
                case AnyKeyboard.KEYCODE_LANG_CHANGE_WITH_IMAGE:
                	setIconIfNeeded(key, localResources, R.drawable.lang_change, R.drawable.lang_change_feedback);
                    break;
                case AnyKeyboard.KEYCODE_SYMB_CHANGE_WITH_IMAGE:
                	setIconIfNeeded(key, localResources, R.drawable.sym_change, R.drawable.sym_change_feedback);
                    break;
...
//                    break;
	...
	protected void setKeyIcons(Key key, Resources localResources, int iconId,
			int iconFeedbackId) {
    	...
    	else
    	{
	        switch (action) {
	            case EditorInfo.IME_ACTION_GO:
	            	...
	            	try
	            	{
	            		setKeyIcons(mEnterKey, res, R.drawable.go_key, R.drawable.go_key_feedback);
	            	}
	            ...
	            case EditorInfo.IME_ACTION_NEXT:
	            	try
	            	{
	            		setKeyIcons(mEnterKey, res, R.drawable.next_key, R.drawable.next_key_feedback);
	            	}
	            	catch(android.content.res.Resources.NotFoundException e)
	            	{
	            		mEnterKey.iconPreview = null;
	            ...
	            case EditorInfo.IME_ACTION_DONE:
	            	try
	            	{
	            		setKeyIcons(mEnterKey, res, R.drawable.done_key, R.drawable.done_key_feedback);
	            	}
	            	catch(android.content.res.Resources.NotFoundException e)
	            	{
	            		mEnterKey.iconPreview = null;
	            ...
	            case EditorInfo.IME_ACTION_SEND:
	            	try
	            	{
	            		setKeyIcons(mEnterKey, res, R.drawable.send_key, R.drawable.send_key_feedback);
	            	}
	            	catch(android.content.res.Resources.NotFoundException e)
	            	{
	            		mEnterKey.iconPreview = null;
...
//	            	}
	...
	public boolean setShifted(boolean shiftState) 
	{
		...
		if (AnySoftKeyboardConfiguration.DEBUG) Log.d(TAG, "New shift ON: "+mShiftKey.on);
		return changed;
