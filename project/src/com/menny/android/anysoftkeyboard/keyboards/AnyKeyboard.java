...
public abstract class AnyKeyboard extends Keyboard {
    ...
    protected AnyKeyboard(AnyKeyboardContextProvider askContext, Context context,// note:
            ...
            // different
            // package!
            int xmlLayoutResId, ThemeResources themeResources) {
        ...
        mOnShiftIcon = mThemeResources.getDrawable(R.id.theme_drawableSymKeyboardShiftLocked);
        if (mOnShiftIcon == null) {
            mOnShiftIcon = askContext.getApplicationContext().getResources().getDrawable(
                    R.drawable.sym_keyboard_shift_on);
        }
        mOffShiftIcon = mThemeResources.getDrawable(R.id.theme_drawableSymKeyboardShift);
        if (mOffShiftIcon == null) {
            mOffShiftIcon = askContext.getApplicationContext().getResources().getDrawable(
            ...
            if ((key.codes != null) && (key.codes.length > 0)) {
                ...
                switch (primaryCode) {
                    case AnyKeyboard.KEYCODE_DELETE:
                        key.icon = mThemeResources
                                .getDrawable(R.id.theme_drawableSymKeyboardDelete);
                        if (key.icon == null) {
                            key.icon = localResources
                                    .getDrawable(R.drawable.sym_keyboard_delete_small);
                        }
                        break;
                    case AnyKeyboard.KEYCODE_SHIFT:
                        mShiftKey = key;// I want the reference used by the
                        // super.
                        key.icon = mThemeResources.getDrawable(R.id.theme_drawableSymKeyboardShift);
                        if (key.icon == null) {
                            key.icon = localResources.getDrawable(R.drawable.sym_keyboard_shift);
                        }
                        break;
                    case AnyKeyboard.KEYCODE_CTRL:
                        key.icon = mThemeResources.getDrawable(R.id.theme_drawableSymKeyboardCtrl);
                        if (key.icon == null) {
                            key.icon = localResources.getDrawable(R.drawable.sym_keyboard_ctrl);
                        }
                        break;
                    case 32:// SPACE
                        key.icon = mThemeResources.getDrawable(R.id.theme_drawableSymKeyboardSpace);
                        if (key.icon == null) {
                            key.icon = localResources.getDrawable(R.drawable.sym_keyboard_space);
                        }
                        break;
                    case 9:// TAB
                        key.icon = mThemeResources.getDrawable(R.id.theme_drawableSymKeyboardTab);
                        if (key.icon == null) {
                    ...
                    case 48: // zero
                        // XXX
                        if (mXmlLayoutResId == R.xml.simple_numbers) {
                            key.icon = mThemeResources
                                    .getDrawable(R.id.theme_drawableSymKeyboardNum0);
                            if (key.icon == null) {
                                key.icon = localResources.getDrawable(R.drawable.sym_keyboard_num0);
                            }
                        }
                        break;
                    case 49: // one
                        ...
                        if (mXmlLayoutResId == R.xml.simple_numbers) {
                            key.icon = mThemeResources
                                    .getDrawable(R.id.theme_drawableSymKeyboardNum1);
                            if (key.icon == null) {
                                key.icon = localResources.getDrawable(R.drawable.sym_keyboard_num1);
                            }
                        }
                        break;
                    case 50: // two
                        ...
                        if (mXmlLayoutResId == R.xml.simple_numbers) {
                            key.icon = mThemeResources
                                    .getDrawable(R.id.theme_drawableSymKeyboardNum2);
                            if (key.icon == null) {
                                key.icon = localResources.getDrawable(R.drawable.sym_keyboard_num2);
                            }
                        }
                    ...
                    case 51: // three
                        ...
                        if (mXmlLayoutResId == R.xml.simple_numbers) {
                            key.icon = mThemeResources
                                    .getDrawable(R.id.theme_drawableSymKeyboardNum3);
                            if (key.icon == null) {
                                key.icon = localResources.getDrawable(R.drawable.sym_keyboard_num3);
                            }
                        }
                    ...
                    case 52: // four
                        ...
                        if (mXmlLayoutResId == R.xml.simple_numbers) {
                            key.icon = mThemeResources
                                    .getDrawable(R.id.theme_drawableSymKeyboardNum4);
                            if (key.icon == null) {
                                key.icon = localResources.getDrawable(R.drawable.sym_keyboard_num4);
                            }
                        }
                        break;
                    case 53: // five
                        ...
                        if (mXmlLayoutResId == R.xml.simple_numbers) {
                            key.icon = mThemeResources
                                    .getDrawable(R.id.theme_drawableSymKeyboardNum5);
                            if (key.icon == null) {
                                key.icon = localResources.getDrawable(R.drawable.sym_keyboard_num5);
                            }
                        }
                        break;
                    case 54: // six
                        ...
                        if (mXmlLayoutResId == R.xml.simple_numbers) {
                            key.icon = mThemeResources
                                    .getDrawable(R.id.theme_drawableSymKeyboardNum6);
                            if (key.icon == null) {
                                key.icon = localResources.getDrawable(R.drawable.sym_keyboard_num6);
                            }
                        }
                        break;
                    case 55: // seven
                        ...
                        if (mXmlLayoutResId == R.xml.simple_numbers) {
                            key.icon = mThemeResources
                                    .getDrawable(R.id.theme_drawableSymKeyboardNum7);
                            if (key.icon == null) {
                                key.icon = localResources.getDrawable(R.drawable.sym_keyboard_num7);
                            }
                        }
                        break;
                    case 56: // eight
                        ...
                        if (mXmlLayoutResId == R.xml.simple_numbers) {
                            key.icon = mThemeResources
                                    .getDrawable(R.id.theme_drawableSymKeyboardNum8);
                            if (key.icon == null) {
                                key.icon = localResources.getDrawable(R.drawable.sym_keyboard_num8);
                            }
                        }
                        break;
                    case 57: // nine
                        ...
                        if (mXmlLayoutResId == R.xml.simple_numbers) {
                            key.icon = mThemeResources
                                    .getDrawable(R.id.theme_drawableSymKeyboardNum9);
                            if (key.icon == null) {
                                key.icon = localResources.getDrawable(R.drawable.sym_keyboard_num9);
                            }
                        }
                        break;
                    case 63:
                    ...
                    case AnyKeyboard.KEYCODE_LANG_CHANGE:
                        if ((key.edgeFlags & Keyboard.EDGE_TOP) != 0) {// these
                            // keys
                            // should
                            // only
                            // be
                            ...
                            // top
                            // row.
                            final String keysMode = AnySoftKeyboardConfiguration.getInstance()
                                    .getChangeLayoutKeysSize();
                            if (keysMode.equals("None")) {
                                key.label = null;
                                key.height = 0;
                                key.width = 0;
                            } else if (keysMode.equals("Big")) {
                                String keyText = (primaryCode == Keyboard.KEYCODE_MODE_CHANGE) ? mASKContext
                                        .getApplicationContext().getString(
                                                R.string.change_symbols_regular)
                                        : mASKContext.getApplicationContext().getString(
                                                R.string.change_lang_regular);
                                key.label = keyText;
                                // key.height *= 1.5;
                            } else {
                                String keyText = (primaryCode == Keyboard.KEYCODE_MODE_CHANGE) ? mASKContext
                                        .getApplicationContext().getString(
                                                R.string.change_symbols_wide)
                                        : mASKContext.getApplicationContext().getString(
                                                R.string.change_lang_wide);
                                key.label = keyText;
                            }
                        }
                        break;
    ...
    protected ThemeResources getThemeResources() {
    ...
    protected Key createKeyFromXml(Resources res, Row parent, int x, int y, XmlResourceParser parser) {
        if (mSpecialShiftKeys == null) {
            mSpecialShiftKeys = new HashMap<Character, ShiftedKeyData>();
        }
        ...
        if (mDebug) {
            final int primaryKey = ((key.codes != null) && key.codes.length > 0) ? key.codes[0]
                    : -1;
            Log.v(TAG, "Key '" + primaryKey + "' will have - width: " + key.width + ", height:"
                    + key.height + ", text: '" + key.label + "'.");
        }
        ...
        if ((key.codes != null) && (key.codes.length > 1)) {
            ...
            if ((primaryCode > 0) && (primaryCode < Character.MAX_VALUE)) {
                ...
                if (mDebug) {
                    Log.v(TAG, "Adding mapping (" + primary + "->" + keyData.ShiftCharacter
                            + ") to mSpecialShiftKeys.");
                }
            }
        }
    ...
    protected Row createRowFromXml(Resources res, XmlResourceParser parser) {
        ...
        if ((aRow.rowEdgeFlags & EDGE_TOP) != 0) {
            String layoutChangeType = AnySoftKeyboardConfiguration.getInstance()
                    .getChangeLayoutKeysSize();
            // top row
        ...
        if (res.getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            aRow.defaultHeight = (int) (aRow.defaultHeight * AnySoftKeyboardConfiguration
                    .getInstance().getKeysHeightFactorInPortrait());
        } else if (res.getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            aRow.defaultHeight = (int) (aRow.defaultHeight * AnySoftKeyboardConfiguration
                    .getInstance().getKeysHeightFactorInLandscape());
        }
    ...
    private boolean isAlphabetKey(Key key) {
        return (!key.modifier) && (!key.sticky) && (!key.repeatable) && (key.icon == null)
                && (key.codes[0] > 0);
    }
    ...
    public void setImeOptions(Resources res, EditorInfo editor) {
        ...
        if (inNoEnterActionMode) {
            ...
            mEnterKey.icon = mThemeResources.getDrawable(R.id.theme_drawableSymKeyboardReturn);
            if (mEnterKey.icon == null) {
            ...
            switch (action) {
                case EditorInfo.IME_ACTION_GO:
                    ...
                    mEnterKey.label = Workarounds.workaroundCorrectStringDirection(res
                            .getText(R.string.label_go_key));
                    break;
                case EditorInfo.IME_ACTION_NEXT:
                    ...
                    // there is a problem with LTR languages
                    mEnterKey.label = Workarounds.workaroundCorrectStringDirection(res
                            .getText(R.string.label_next_key));
                    break;
                ...
                case EditorInfo.IME_ACTION_SEARCH:
                    mEnterKey.icon = mThemeResources
                            .getDrawable(R.id.theme_drawableSymKeyboardSearch);
                    if (mEnterKey.icon == null) {
                ...
                case EditorInfo.IME_ACTION_SEND:
                    ...
                    // there is a problem with LTR languages
                    mEnterKey.label = Workarounds.workaroundCorrectStringDirection(res
                            .getText(R.string.label_send_key));
                    break;
                ...
                default:
                    ...
                    // (imeActionId > 0))
                    // {
                    // Log.d(TAG, "Input has provided its own ENTER label: "+
                    // imeLabel);
                    // mEnterKey.iconPreview = null;
                    // mEnterKey.icon = null;
                    // //there is a problem with LTR languages
                    ...
                    // {
                    mEnterKey.icon = mThemeResources
                            .getDrawable(R.id.theme_drawableSymKeyboardReturn);
                    if (mEnterKey.icon == null) {
                        mEnterKey.icon = res.getDrawable(R.drawable.sym_keyboard_return);
                    }
                    mEnterKey.label = null;
    ...
    public void setShiftLocked(boolean shiftLocked) {
        if (mShiftKey != null) {
            if (mDebug) {
                Log.d(TAG, "setShiftLocked: Switching to locked: " + shiftLocked);
            }
    ...
    public boolean setShifted(boolean shiftState) {
        ...
        // making sure it is off. Only caps turn it on. The super will turn the
        // lit on when
        ...
        if (mDebug) {
            Log.d(TAG, "setShifted: shiftState:" + shiftState + ". super result:" + superResult
                    + " changed: " + changed);
        }

        if (changed || superResult) {// layout changed. Need to change labels.
        ...
        switch (variation) {
            ...
            case EditorInfo.TYPE_TEXT_VARIATION_URI:
                if (mSmileyKey != null) {
                    ...
                    // "Changing smiley key to domains.");
                    mSmileyKey.iconPreview = null;// res.getDrawable(sym_keyboard_key_domain_preview);
                    mSmileyKey.icon = mThemeResources
                            .getDrawable(R.id.theme_drawableSymKeyboardDomain);
                    if (mSmileyKey.icon == null) {
                ...
                if (mQuestionMarkKey != null) {
                    // Log.d("AnySoftKeyboard",
                    // "Changing question mark key to AT.");
                    mQuestionMarkKey.codes[0] = '@';
            ...
            default:
                if (mSmileyKey != null) {
                    // Log.d("AnySoftKeyboard",
                    // "Changing smiley key to smiley.");
                    mSmileyKey.icon = mThemeResources
                            .getDrawable(R.id.theme_drawableSymKeyboardSmiley);
                    if (mSmileyKey.icon == null) {
                ...
                if (mQuestionMarkKey != null) {
                    // Log.d("AnySoftKeyboard",
                    // "Changing question mark key to question.");
                    mQuestionMarkKey.codes[0] = '?';
                    mQuestionMarkKey.label = "?";
    ...
    public int getShiftedKeyValue(int primaryCode) {
        if ((primaryCode > 0) && (primaryCode < Character.MAX_VALUE)) {
            ...
            if (mSpecialShiftKeys.containsKey(c)) {
                ...
                if (mDebug) {
                    Log.v(TAG, "Returned the shifted mapping (" + c + "->" + shifted
                            + ") from mSpecialShiftKeys.");
                }
                return shifted;
            }
        }
    ...
    static class AnyKey extends Keyboard.Key {
        ...
        public AnyKey(Resources res, Keyboard.Row parent, int x, int y, XmlResourceParser parser) {
    ...
    protected static class LessSensitiveAnyKey extends AnyKey {
        ...
        void resetSenitivity() {
            ...
            if ((this.edgeFlags & Keyboard.EDGE_BOTTOM) != 0) {// the enter key!
                // we want to "click" it only if it in the lower
                mStartY += (this.height * 0.15);
            } else {
                if ((this.edgeFlags & Keyboard.EDGE_LEFT) != 0) {// usually,
                    // shift
                    mEndX -= (this.width * 0.1);
                }

                if ((this.edgeFlags & Keyboard.EDGE_RIGHT) != 0) {// usually,
                    // delete
                    // this is below the ENTER.. We want to be careful with
                    // this.
        ...
        public boolean isInside(int clickedX, int clickedY) {
            return clickedX >= mStartX && clickedX <= mEndX && clickedY >= mStartY
                    && clickedY <= mEndY;
        }
    }
    ...
    private static class EnterKey extends LessSensitiveAnyKey {
        ...
        public EnterKey(Resources res, Row parent, int x, int y, XmlResourceParser parser) {
            super(res, parent, x, y, parser);
