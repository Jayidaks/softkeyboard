...
public class ThemeResources {
	private static final String TAG = "ASK ThemeResources";
	...
	public ThemeResources(Context context, ThemePluginInfo pluginInfo,
		...
		// and calling through the IPC binder API. It's more effective in this
		// way
		...
		try {
			...
			ThemePlugin plugin = (ThemePlugin) m.invoke(cls.newInstance(),
					new Object[] { null });
	 ...
	 * @param resMapping
	 */
	public ThemeResources(Context context, Map<Integer, Integer> resMapping,
			ThemeResources defaultRes) {
		this(context.getResources(), resMapping, defaultRes);
	}

	public ThemeResources(Resources packageRes,
			Map<Integer, Integer> resMapping, ThemeResources defaultRes) {
	 ...
	 *
	 * @param id
	 *            The ID of the string resource defined in
	 *            {@link com.android.im.plugin.BrandingResourceIDs}
	 * @param formatArgs
